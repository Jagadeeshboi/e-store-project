...
<head>
    ...
    <link rel="icon" type="image/png" href="coll/e design.jpg" style="border-radius: 50px;">
		  ...
		  <aside>
			<div class="wrapper">
		       ...
		       <ul>
                ...
                <li>
                    <a href="Electronic-components.php" class="active">
...
<lottie-player src="https://assets2.lottiefiles.com/packages/lf20_ZLL9BMHuN9.json"  background="transparent"  speed="1"  style="width: 100px; height: 100px;"  loop  autoplay></lottie-player>
        ...
        $sql="SELECT * FROM electronic_components";
        ...
        while($row=$result->fetch_assoc())
        {
            ...
            <div class="container1">
                ...
                <div>
                    ...
                    <h2 style="margin-left:10px;margin-top:20px;"><?php echo "₹".$row['price'];?></h2>
                </div>
                <div style="width: 30%; text-align:right;margin-top:70px">
